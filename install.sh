...
echho; echo "@tualizando bot, aguarde..."; echo; wget https://github.com/endblack/WaBot-VendasSSH/raw/main/mult/index.js > /dev/null 2>&1; wget https://github.com/endblack/WaBot-VendasSSH/raw/main/mult/veri.js > /dev/null 2>&1; wget https://github.com/endblack/WaBot-VendasSSH/raw/main/mult/gerar.js > /dev/null 2>&1; wget https://github.com/endblack/WaBot-VendasSSH/raw/main/mult/qrcode > /dev/null 2>&1; chmod +x qrcode; mv qrcode /bin; mv index.js /etc/megahbot; mv veri.js gerar.js /etc/megahbot/src; echo; echo "Atualizaçço terminada! digite onbot para rodar o novo programa"; echo; exit 0 }
